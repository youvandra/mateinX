    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-6 py-20">
          <img src="/Logo.svg" alt="mateinX" className="h-14 w-14 mb-6" />
          <h1 className="text-5xl md:text-7xl font-bold text-terminal-900 leading-tight">
            Solve Chess Puzzles,<br />
            <span className="text-terminal-600">Earn Crypto Rewards</span>
          </h1>
          <p className="text-lg md:text-xl text-terminal-700 mt-5 max-w-2xl leading-relaxed">
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            <a
              href="/dashboard"
              className="inline-block px-8 py-3.5 bg-terminal-800 text-white text-sm font-mono hover:bg-terminal-700 transition-colors border border-terminal-800"
            >
              $ start_solving
            </a>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-block px-8 py-3.5 bg-white text-terminal-800 text-sm font-mono hover:bg-terminal-50 transition-colors border border-terminal-300"
            >
              $ learn_about_OKX.AI
            </a>
          </div>

          <div className="flex flex-wrap gap-3 mt-8 text-sm font-mono">
      ...
      <section className="py-24 px-6 max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <p className="text-xs font-mono text-terminal-400 uppercase tracking-widest mb-3">How It Works</p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="border border-terminal-200 bg-white p-8 text-center">
            <div className="w-12 h-12 border border-terminal-300 bg-terminal-50 flex items-center justify-center mx-auto mb-5">
              <span className="text-lg font-bold text-terminal-700">01</span>
            </div>
          ...
          <div className="border border-terminal-200 bg-white p-8 text-center">
            <div className="w-12 h-12 border border-terminal-300 bg-terminal-50 flex items-center justify-center mx-auto mb-5">
              <span className="text-lg font-bold text-terminal-700">02</span>
            </div>
          ...
          <div className="border border-terminal-200 bg-white p-8 text-center">
            <div className="w-12 h-12 border border-terminal-300 bg-terminal-50 flex items-center justify-center mx-auto mb-5">
              <span className="text-lg font-bold text-terminal-700">03</span>
            </div>
      ...
      {/* Stats / Features */}
      <section className="border-t border-terminal-200 bg-terminal-50 py-20 px-6">
      ...
      <section className="py-24 px-6 text-center">
        ...
        <p className="text-terminal-600 mt-3 max-w-lg mx-auto">
