      ...
      >
        ...
        <div className="relative z-10 w-full px-4 sm:px-8 md:px-16 py-16 sm:py-24">
          <div className="max-w-3xl">
            <h1 className="text-3xl sm:text-4xl md:text-7xl font-bold text-terminal-900 leading-tight tracking-wide flex flex-col">
              <span className="text-nowrap">Solve Chess Puzzles,</span>
              <span className="text-nowrap text-terminal-600">Earn Crypto Rewards</span>
            </h1>
            <p className="text-sm sm:text-base md:text-lg text-terminal-700 mt-6 sm:mt-10 leading-relaxed max-w-xl">
